...
CREATE OR REPLACE  VIEW LISTA_MASCOTA_DETALLE AS  SELECT  C.NOMBRE_CLI||' '|| C.APELLIDO1 ||' '|| C.APELLIDO2 AS "NOMBRE COMPLETO CLIENTE", NOMBRE_MASCOTA AS "NOMBRE DE LA MASCOTA", RAZA,TIPO_ANIMAL,EDAD,NOMBRE_CLI ,DESCRIPCION  ,NOMBRE_VACUNA
FROM MASCOTA M INNER JOIN CLIENTE C ON C.ID_CLIENTE=M.ID_CLIENTE 
INNER JOIN VACUNA_APLICADA VP ON VP.ID_MASCOTA=M.ID_MASCOTA 
INNER JOIN VACUNA V ON V.ID_VACUNA=VP.ID_VACUNA;
/*
#TEST
SELECT * FROM LISTA_MASCOTA_DETALLE;
*/
