...
<ul class="nav ">
  ...
  <?php
      ...
      $sql ="select * from auditaEmpleado";
      ...
      function ImprimeDatos($stmt)
            ...
            function imprimeTabla($stmt)
            {
              ...
              echo "<th scope='col'>Rol_Nuevo</th>";
              echo "<th scope='col'>Rol_viejo</th>";
              echo "<th scope='col'>Usuairo</th>";
              ...
              echo "</thead>";
                if (true) {
                    ...
                    while ($row = $stmt->fetch()) {
                        ...
                        echo "<th scope='row'>".$row['NOMBRE_EMPLEADO']."</th>";
                        echo "<td>".$row['ROL_NUEVO']."</td>";
                        echo "<td>".$row['ROL_ANTIGUO']."</td>";
                        echo "<td>".$row['USAURIO']."</td>";
