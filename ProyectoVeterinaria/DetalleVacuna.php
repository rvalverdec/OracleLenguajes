...
<?php
      ...
      $sql ="SELECT * FROM LISTA_MASCOTA_DETALLE";
      ...
      function ImprimeDatos($stmt)
            ...
            function imprimeTabla($stmt)
            {
              ...
              echo "<th scope='col'>Nombre Mascota</th>";
              echo "<th scope='col'>Raza</th>";
              echo "<th scope='col'>Tipo de Animal</th>";
              echo "<th scope='col'>Edad</th>";
              echo "<th scope='col'>Descipcion de Vacuna</th>";
              echo "<th scope='col'>Vacuna</th>";
              echo "</tr>";
              echo "</thead>";
                if (true) {
                    echo "<tbody>";
                    ...
                    while ($row = $stmt->fetch()) {
                        ...
                        echo "<th scope='row'>".$row["NOMBRE COMPLETO CLIENTE"]."</th>";
                        echo "<td>".$row['NOMBRE DE LA MASCOTA']."</td>";
                        echo "<td>".$row['RAZA']."</td>";
